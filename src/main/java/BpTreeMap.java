...
//    out.println ("this node reference #" + i);
 ...
 public static void main (String [] args)
 {
  ...
  /*Testing return classes*/
  public String rootToString(int index) {
    String myString = "" + this.root.key[index];
    return myString;
  }
  
  public String rootArrayToString() {
    String myString = "";
    for(int x = 0; x < 3; x++){
      myString = myString + "," + this.root.ref[x];
    }
